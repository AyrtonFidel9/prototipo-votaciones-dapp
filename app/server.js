...
async function main() {
    ...
    try {
        ...
        // const billeteraN = await Billetera.create({
        //     address: sequelize.fn('PGP_SYM_ENCRYPT','0xDB95ed68B4Bf0844e424322aD7f1CABB9743A41C',process.env.SECRET_KEY_DATABASE),
        //     privateKey: web3.eth.accounts.encrypt('998096b7f26ec0aabfa72b15b17e80eabeee98ae249e760be37baa2369a2645b', process.env.SECRET_KEY_WALLET),
        // });

        // const socioN = await Socios.update({
        //     nombres: 'Jane Jane',
        ...
        //     billeteraAddress: billeteraN.address,
        // },{
        //     where: {
        //         id: 1
        //     }
