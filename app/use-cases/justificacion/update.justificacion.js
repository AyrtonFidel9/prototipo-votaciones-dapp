...
export const justificacionUpdate = async (
  idJustificacion,
  oldDoc,
  { fecha, documento, idSocio, idElecciones, estado }
) => {
  try {
    if (oldDoc !== documento)
      oldDoc == null ||
        oldDoc == "" ||
        fs.unlinkSync("./app/public/docs/justificacion/" + oldDoc);
    else documento = oldDoc;
